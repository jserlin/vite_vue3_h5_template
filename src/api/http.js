import { ContentTypeEnum, RequestBodyEnum, RequestHttpEnum } from '@/enums/httpEnum'
...
export const post = (url, data, headersType) => {
  return axiosInstance({
    url: url,
...
export const patch = (url, data, headersType) => {
  return axiosInstance({
    url: url,
...
export const put = (url, data, headersType) => {
  return axiosInstance({
    url: url,
